...
- (void)setupDefaultColorStates {
    ...
    self.floatingLabelActiveTextColor = [UIColor whiteColor];//self.floatingLabelActiveTextColor ?: defaultActiveColor;
    self.floatingLabelInactiveTextColor = [UIColor whiteColor]; //self.floatingLabelInactiveTextColor ?: [UIColor colorWithWhite:0.7f alpha:1.f];
...
- (void)drawRect:(CGRect)aRect
{
    ...
    if (self.shouldDrawPlaceholder) {
        ...
        NSLog(@"frame: %@", NSStringFromCGRect(placeholderFrame));
